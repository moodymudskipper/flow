...
*{flow}* is built on top of Javier Luraschi's *{nomnoml}* package, which provides
an interface to nomnoml, a tool for drawing sassy UML diagrams based on syntax 
...
There are way too many features to show them all on a README, check the vignette
[Draw a function](http://htmlpreview.github.io/?https://raw.githubusercontent.com/moodymudskipper/flow/master/doc/Draw-a-function.html) for a deeper dive. More vignette to come!
