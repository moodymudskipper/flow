...
This can be undesirable for observation, web pages, pdfs etc where we'd like
to have everything fit on the width of the page whenever possible. The `narrow`
argument makes it possible, at the cost of drawing a longer diagram. 
...
You might define or encounter functions which themselves contain another function
definition. It will often be anonymous functions, but not always.

The `sub_fun_id` argument allows you to explore those.
